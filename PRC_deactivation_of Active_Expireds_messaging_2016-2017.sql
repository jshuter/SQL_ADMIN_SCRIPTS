...
declare @debug				int = 1 ; -- to limit to partial send -- NOT FOR PROD !!!!
...
------------------------------------------------
	...
	begin 
		...
		<p>If you wish to continue your membership, you can simply go to Backcheck to renew your PRC. Please note there is a small charge for using this service. 
		...
		<p>Si vous souhaitez demeurer un membre actif de Scouts Canada, nous vous invitons &agrave; utiliser le service  Backcheck pour renouveler 
